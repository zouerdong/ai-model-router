...
当前仓库为本地门禁已通过、尚未发布的 `2.0.0` 候选（2026-09-10 登记，`docs/25` DS41-1~5）：唯一 `deepseek` Profile 全面迁移到 DeepSeek V4.1 Flash（官方 ID `deepseek-flash`），删除 `deepseek-vision` Profile 与 `deepseek-auto`/`deepseek-flash-vision` 旧品牌别名，只保留规范入口 `deepseek` 和通用兼容别名 `build`。Provider、Secret 与鉴权边界不变；本地 184 tests 为 181 pass / 0 fail / 3 Windows-only skip，lint/diff/list/pack 门全绿；公开 Latest 与安装 URL 在发布门禁闭环前仍为 `1.8.2`。
...
未发布候选登记：`2.0.0`（`docs/25` DS41-1~5，2026-09-10 登记），当前只获仓库内实施与本地验证授权；commit、push、Windows CI、tag 与 Release 均未授权。原 `1.8.2` 候选（`docs/24` DCP-1~4，2026-08-29 登记）已于同日经项目负责人授权公开发布并完成全部门禁；原 `1.8.1` 热修复候选（`docs/23` HF-1~4，2026-08-27 登记）已于同日经项目负责人授权随 `1.8.1` 公开发布并完成全部门禁（含 HF-3 自愈门禁）；原 `1.8.0` 候选（`docs/22` GFA-1~6，2026-08-26 登记）已于 2026-08-27 随 `1.8.0` 公开发布并完成全部门禁。
